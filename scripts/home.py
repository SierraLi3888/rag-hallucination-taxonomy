...
def render_home(records, repo):
    ...
    chapter_labels = {
        '4.1 Stage Role and Boundary': '4.1 Role & boundary',
        '4.2 Major Failure Mechanisms': '4.2 Failure mechanisms',
        '4.3 Comparison of Existing Literature': '4.3 Literature comparison',
        '4.4 Cross-Stage Effects and Hallucination Manifestations': '4.4 Effects & hallucination',
        '4.5 Section Conclusion': '4.5 Conclusion',
        '4.2.1 Ambiguous or Incomplete Queries': '4.2.1 Query ambiguity',
        '4.2.2 Query Reformulation Problems': '4.2.2 Reformulation',
        '4.2.3 Query–Document Mismatch': '4.2.3 Mismatch',
        '4.2.4 Missing Relevant Evidence': '4.2.4 Missing evidence',
        '4.2.5 Irrelevant Retrieved Passages': '4.2.5 Irrelevant passages',
        '4.2.6 Ranking and Evidence Selection Failures': '4.2.6 Ranking & selection',
        '4.2.7 Multi-Hop Retrieval Failures': '4.2.7 Multi-hop failures',
        '4.3.1 Query Reformulation and Supervision': '4.3.1 Query supervision',
        '4.3.2 Retriever Alignment and Bias': '4.3.2 Alignment & bias',
        '4.3.3 Evidence Coverage and Diagnostic Granularity': '4.3.3 Evidence coverage',
        '4.3.4 Ranking and Evidence Set Selection': '4.3.4 Evidence selection',
        '4.3.5 Multi-Hop Dependencies and Iterative Retrieval': '4.3.5 Dependencies',
        '4.3.6 Evaluation of Evidence Sufficiency and Hallucination': '4.3.6 Evaluation',
        '4.4.1 From Missing Evidence to Unsupported Completion': '4.4.1 Unsupported claims',
        '4.4.2 From Distractors to Misleading or Incorrectly Attributed Claims': '4.4.2 Misapplied evidence',
        '4.4.3 From Partial Evidence to Incomplete or Contradictory Synthesis': '4.4.3 Partial synthesis',
        '4.4.4 Conditions for Attributing a Hallucination Reduction to Retrieval': '4.4.4 Causal assessment',
    }
